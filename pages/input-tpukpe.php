				...
				<tbody>
					...
					?>
						<tr bgcolor="<?php echo $bgcolor; ?>">
							...
							<td align="center"><div class="btn-group" style="margin-bottom:5px; float:center;">
							<a href="pages/cetak/cetak_tpukpe.php?no_tpukpe=<?php echo $r['no_tpukpe'] ?>"class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; } ?>" target="_blank" data-toggle="tooltip" data-placement="bottom"  title="Retur"><i class="fa fa-print"></i> </a>
							<a href="pages/cetak/cetak_tpukpe_major.php?no_tpukpe=<?php echo $r['no_tpukpe'] ?>" class="btn btn-success btn-xs" target="_blank" data-toggle="tooltip" data-placement="bottom"  title="Major/Repeat"><i class="fa fa-print"></i> </a>
