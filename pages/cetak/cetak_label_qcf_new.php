...
<table width="100%" border="0"style="width: 7in;">
  <tbody>    
	...
	border-left:0px #000000 solid; border-right:0px #000000 solid;"><div style="font-size: 8px;"><?php if($r1['element']!=""){ echo $r1['element']; }else if($cekr>0){echo $r['nodemand'];}else{echo $r1['nodemand'];}?></div></td>
        </tr>
        <tr>
          <td colspan="3" style="border-top:0px #000000 solid; border-bottom:0px #000000 solid;
	...
	border-left:0px #000000 solid; border-right:0px #000000 solid;"><div style="font-size: 8px;">
            <?php if($r1['element']!=""){ echo $r1['element']; }else if($cekr>0){echo $r['nodemand'];}else{echo $r1['nodemand'];}?>
          </div></td>
        </tr>
        <tr>
          <td colspan="3" style="border-top:0px #000000 solid; border-bottom:0px #000000 solid;
