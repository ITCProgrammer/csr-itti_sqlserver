  ...
  <tr>
            ...
            <tr>
                ...
                <table style="width:7in; height:3.2in;" border="0" class="table-list1">
                    ...
                    <tr>
                        ...
                        <td align="left" style="font-size:8px;"><?php echo (isset($row['no_hanger']) && trim($row['no_hanger']) !== '' ? $row['no_hanger'].' / ' : '').substr($row['jenis_kain'],0,45);?></td>
                    ...
                    <tr>
                        ...
                        <td align="left" style="font-size:8px;"><?php echo (isset($row1['no_hanger']) && trim($row1['no_hanger']) !== '' ? $row1['no_hanger'].' / ' : '').$row1['jenis_kain'];?></td>
                    ...
                    <tr>
                        ...
                        <td align="left" style="font-size:8px;"><?php echo (isset($row2['no_hanger']) && trim($row2['no_hanger']) !== '' ? $row2['no_hanger'].' / ' : '').$row2['jenis_kain'];?></td>
                    ...
                    <tr>
                        ...
                        <table width="100%">
                            <tbody>
                                <?php
                                // Tampilkan keterangan hanya jika id_cek, id_cek1, id_cek2 ada di GET dan ada isinya
                                $no = 1;
                                if (!empty($_GET['id_cek'])) {
                                    $qry4 = mysqli_query($con, "SELECT * FROM tbl_detail_retur_now WHERE id='" . $_GET['id_cek'] . "'");
                                    ...
                                    if (!empty($row4['ket'])) {
                                        echo '<tr>
                                            <td width="14%" align="left" valign="top" style="border-top:0px #000000 solid; 
                                                border-bottom:0px #000000 solid;
                                                border-left:0px #000000 solid; 
                                                border-right:0px #000000 solid;">' . $no . '. ' . $row4['ket'] . ' ' . $row4['tgl_keputusan'] . '</td>
                                        </tr>';
                                        $no++;
                                    }
                                }
                                if (!empty($_GET['id_cek1'])) {
                                    $qry5 = mysqli_query($con, "SELECT * FROM tbl_detail_retur_now WHERE id='" . $_GET['id_cek1'] . "'");
                                    ...
                                    if (!empty($row5['ket'])) {
                                        echo '<tr>
                                            <td width="14%" align="left" valign="top" style="border-top:0px #000000 solid; 
                                                border-bottom:0px #000000 solid;
                                                border-left:0px #000000 solid; 
                                                border-right:0px #000000 solid;">' . $no . '. ' . $row5['ket'] . ' ' . $row5['tgl_keputusan'] . '</td>
                                        </tr>';
                                        $no++;
                                    }
                                }
                                if (!empty($_GET['id_cek2'])) {
                                    $qry6 = mysqli_query($con, "SELECT * FROM tbl_detail_retur_now WHERE id='" . $_GET['id_cek2'] . "'");
                                    ...
                                    if (!empty($row6['ket'])) {
                                        echo '<tr>
                                            <td width="14%" align="left" valign="top" style="border-top:0px #000000 solid; 
                                                border-bottom:0px #000000 solid;
                                                border-left:0px #000000 solid; 
                                                border-right:0px #000000 solid;">' . $no . '. ' . $row6['ket'] . ' ' . $row6['tgl_keputusan'] . '</td>
                                        </tr>';
                                        $no++;
                                    }
                                }
                                ...
                                echo  '<tr>
                                            <td width="14%" align="left" valign="top" style="border-top:0px #000000 solid; 
                                                border-bottom:0px #000000 solid;
                                                border-left:0px #000000 solid; 
                                                border-right:0px #000000 solid;">'  . $row4['catatan_dmf'] . '</td>
                                        </tr>';
    ...
    <tr>
      <td><table style="width:7in" border="0" class="table-list1">
        ...
        <tr>
          <td>Nama</td>
          <td align="center"><input name="nama5" type="text" value="Kamel" size="12" /></td>
          <td align="center"><input name="nama13" type="text" value="<?php echo $row['personil_gkj']; ?>" size="10" /></td>
          <td align="center"><input name="nama3" type="text" value="<?php echo $row['personil_csr']; ?>" size="10" /></td>
          <td align="center"><input name="nama6" type="text" value="<?php echo $row['personil_sales_mkt'];?>" size="10" /></td>
          <td align="center"> 
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center" style="border:0;" type="text" size="10"><?php echo $row['personil_mkt']; ?></td>
                <td align="center" style="border:0;"  type="text" size="10"><?php echo $row['personil_ppc']; ?></td>
              </tr>
            </table>    
          </td>
          <td align="center"><input name="nama10" type="text" value="Mr Xiao Ming" size="10" /></td>
        </tr>
        <tr>
          <td>Tanggal</td>
          <td align="center"><?php echo (!empty($row['tgl_buat_retur']) && strtotime($row['tgl_buat_retur'])) ? date('d-m-y', strtotime($row['tgl_buat_retur'])) : '';?></td>
          <td align="center">
            <input name="nama1" type="text" value="<?php echo (!empty($row['tgl_approved_gkj']) && strtotime($row['tgl_approved_gkj'])) ? date('d-m-y', strtotime($row['tgl_approved_gkj'])) : '';?>" size="10" maxlength="8"/>
          </td>
          <td align="center">
            <input name="nama2" type="text" value="<?php echo (!empty($row['tgl_approved_csr']) && strtotime($row['tgl_approved_csr'])) ? date('d-m-y', strtotime($row['tgl_approved_csr'])) : '';?>" size="10" maxlength="8" />
          </td>
          <td align="center">
            <input name="nama4" type="text" value="<?php echo (!empty($row['tgl_approved_sales_mkt']) && strtotime($row['tgl_approved_sales_mkt'])) ? date('d-m-y', strtotime($row['tgl_approved_sales_mkt'])) : '';?>" size="10" maxlength="8" />
          </td>
          <td align="center">
            <input name="nama7" type="text" value="<?php echo (!empty($row['tgl_approved_mkt']) && strtotime($row['tgl_approved_mkt']))
                ? date('d-m-y', strtotime($row['tgl_approved_mkt']))
                : ((!empty($row['tgl_approved_ppc']) && strtotime($row['tgl_approved_ppc']))
                    ? date('d-m-y', strtotime($row['tgl_approved_ppc']))
                    : ''); ?>" size="10" maxlength="8" />
          </td>
        <td align="center">
            <input name="nama9" type="text" value="<?php echo (!empty($row['approved_dmf']) && !empty($row['tgl_approved_dmf']) && strtotime($row['tgl_approved_dmf'])) ? date('d-m-y', strtotime($row['tgl_approved_dmf'])) : ''; ?>" size="10" maxlength="8" />
        </td>
        </tr>
        <tr>
          <td>Jabatan</td>
          <td align="center"><input name="nama" type="text" value="Staf" size="12" /></td>
          <td align="center">GKJ</td>
          <td align="center">CSR Manager</td>
        ...
        <tr>
          ...
          <td align="center"><?php echo $row['approved_gkj'];?></td>
          <td align="center"><?php echo $row['approved_csr'];?></td>
          <td align="center"><?php echo $row['approved_sales_mkt'];?></td>
          <td align="center">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center" style="border:0;"><?php echo $row['approved_mkt']; ?></td>
                <td align="center" style="border:0;"><?php echo $row['approved_ppc']; ?></td>
              </tr>
            </table>
          </td>
          <!-- <td align="center"><?php echo (isset($row['approved_mkt']) && trim($row['approved_mkt']) !== '') ? $row['approved_mkt'] : (isset($row['approved_ppc']) ? $row['approved_ppc'] : ''); ?></td> -->
          <td align="center"><?php echo $row['approved_dmf'];?></td>
        </tr>
      </table></td>
    </tr>
    <tr>
...
<div style="width:7in; max-width:100%; height:1in; box-sizing:border-box; margin:6px 0;">
    <label for="catatan_mkt" style="display:block; font-size:11px; margin-bottom:4px;">Note Marketing</label>
    <div id="catatan_mkt" style="font-size:10px; border:1px solid #000; width:100%; height:calc(1in - 22px); padding:6px; overflow:auto; box-sizing:border-box; background:#fff;">
        <?php echo nl2br(htmlspecialchars($rbon['catatan_mkt'])); ?>
    </div>
</div>
