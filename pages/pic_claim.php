...
include("../koneksi.php");
    $modal_id=$_GET['id'];
	$modal=mysqli_query($con,"SELECT * FROM `reports_claim` WHERE foto1='$modal_id'");
        ...
        <div class="modal-content">
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="View_Pic" enctype="multipart/form-data">
                <div class="modal-header">
                    ...
                    <h3 id="myModalLabel">View Picture (1) Claim</h3>
                </div>
                <div class="modal-body">
                    <div class="wrapped">
                        <div class="modal-zoom-large-photo-wrap">
                            <div class="absolute">
                                <a id="modal-zoom-photo" class="zoom-in-cursor" href="#"><img class="margin-bottom img-responsive" src="dist/img-disposisinow/<?php echo $r['foto1'];?>"></a>
                            </div>
                        </div>
                    </div>
                </div>
